...
METADATA = {
    ...
    'author':           'rozifus',
    #'author_email':     '',
    'url':              'http://pyweek.org/e/griddlers',
    'classifiers':      [
...
PACKAGEDATA = {
    ...
    'package_dir': {'griddlers': 'griddlers',
                   },
    'packages': ['griddlers',
                ],
    'scripts': ['scripts/griddlers'],
}
...
_DATA_DIR = os.path.join('griddlers', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'griddlers': data_dirs}
...
src = []
add_files(src,os.walk('griddlers'))
